...
root.title("Tuberclusis detection ")


#430
#++++++++++++++++++++++++++++++++++++++++++++
#####For background Image
image2 =Image.open('mainbg.jpg')
...
#
lbl = tk.Label(root, text="Tuberculosis detection using Machine learning", font=('times', 35,' bold '), width=55,height=1,bg="burlywood4",fg="white")
lbl.place(x=0, y=0)




frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=350, bd=5, font=('times', 14, ' bold '),bg="lightgoldenrodyellow")
...
#    global fn
    ...
    if fn!="":
        ...
        model = load_model('C:/Users/SANIKET/Desktop/Tuberclusis detection (1)/Tuberclusis detection/TB_model.h5')
        ...
        if yoga == 0:
            Cd="Tuberculosis Not Detected"
        elif yoga == 1:
            Cd="Tuberculosis Detected"
...
def openimage():
    ...
    global fn
    fileName = askopenfilename(initialdir='D://100% code//My Project//100%Tuberclusis detection//100%Tuberclusis detection//Tuberclusis detection//Tuberculosis', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
...
exit = tk.Button(frame_alpr, text="Exit", command=window, width=15, height=1, font=('times', 15, ' bold '),bg="burlywood4",fg="white")
