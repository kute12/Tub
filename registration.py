...
image2 =image2.resize((1920,1280), Image.ANTIALIAS)
...
frame = tk.LabelFrame(window, text="", width=600, height=570, bd=5, font=('times', 14, ' bold '))
frame.grid(row=0, column=0, sticky='nw')
frame.place(x=470, y=120)

lbl = tk.Label(window, text="Registration Form", font=('times', 35,' bold '), height=1, width=55,bg="skyblue",fg="red")
lbl.place(x=0, y=0)
...
l2 = tk.Label(frame, text="Full Name :", width=12, font=("Times new roman", 15, "bold"),bd=5)
l2.place(x=30, y=30)
...
l3 = tk.Label(frame, text="Address :", width=12, font=("Times new roman", 15, "bold"),bd=5)
l3.place(x=30, y=80)
...
l5 = tk.Label(frame, text="E-mail :", width=12, font=("Times new roman", 15, "bold"))
l5.place(x=30, y=130)
t4 = tk.Entry(frame, textvar=Email, width=20, font=('', 15),bd=5)
t4.place(x=230, y=130)
# that is for email address

l6 = tk.Label(frame, text="Phone number :", width=12, font=("Times new roman", 15, "bold"))
l6.place(x=30, y=180)
t5 = tk.Entry(frame, textvar=Phoneno, width=20, font=('', 15),bd=5)
t5.place(x=230, y=180)
# phone number
l7 = tk.Label(frame, text="Gender :", width=12, font=("Times new roman", 15, "bold"))
l7.place(x=30, y=230)
# gender
tk.Radiobutton(frame, text="Male", padx=5, width=5, font=("bold", 15), variable=var, value=1).place(x=230,
                                                                                                                y=230)
tk.Radiobutton(frame, text="Female", padx=20, width=4, font=("bold", 15), variable=var, value=2).place(
    x=340, y=230)
...
l4 = tk.Label(frame, text="User Name :", width=12, font=("Times new roman", 15, "bold"))
l4.place(x=30, y=330)
t3 = tk.Entry(frame, textvar=username, width=20, font=('', 15),bd=5)
t3.place(x=230, y=330)

l9 = tk.Label(frame, text="Password :", width=12, font=("Times new roman", 15, "bold"))
l9.place(x=30, y=380)
t9 = tk.Entry(frame, textvar=password, width=20, font=('', 15), show="*",bd=5)
t9.place(x=230, y=380)

l10 = tk.Label(frame, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"))
